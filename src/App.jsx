          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col gap-3">
                ...
                {(!project.links || project.links.length === 0) && project.href !== "#" && (
                  <Button asChild size="lg" className="rounded-xl gap-3 font-black uppercase italic tracking-tighter shadow-xl">
      ...
      <section id="hero">
        <div className="mx-auto w-full max-w-2xl">
          <div className="flex items-center justify-between gap-6">
            ...
            {/* Avatar — rounded rectangle for better portrait display */}
          ...
          {DATA.work.map((work, id) => (
            ...
            >
              <ResumeCard
                ...
                href={work.href}
                badges={work.badges}
                period={work.end == null ? `${work.start} - Present` : work.start === work.end ? work.start : `${work.start} - ${work.end}`}
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-2xl mx-auto">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I am always looking for new challenges and opportunities to learn and grow. Here are some of the certificates I have earned.
                </p>
              </div>
            </div>
          </BlurFade>
